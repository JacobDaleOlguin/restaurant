...
const Menu: React.FC = () => {
  ...
  return (
    <div className="select-none w-full min-h-screen flex items-center justify-center bg-cover bg-left" style={{ backgroundImage: `url(${heroMenu})`, filter: 'brightness(75%)' }}>
